  ...
  return (
    <div className="flex h-screen bg-[#212B36] overflow-hidden">
      ...
      <aside 
        ...
        } bg-[#212B36] border-r border-gray-700 transition-all duration-300 hidden lg:flex flex-col`}
      >
        {/* Logo */}
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`w-5 h-5 ${active ? item.color : 'text-gray-200'}`} />
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          {isSidebarOpen && (
            ...
            className="w-full mt-3 flex items-center justify-center gap-2 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"
            >
      ...
      >
        <aside
          className={`fixed left-0 top-0 h-full w-64 bg-[#212B36] transform transition-transform ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Bar Mobile */}
        <div className="lg:hidden h-16 bg-[#212B36] border-b border-gray-700 flex items-center justify-between px-4">
          <button
